...
export function toneSurface(tone: StatusTone) {
  if (tone === 'approved')
    return 'bg-[var(--emerald-soft)] text-[var(--slate-900)] border-[rgba(16,185,129,0.18)]';
  if (tone === 'review')
    return 'bg-[rgba(124,58,237,0.09)] text-[var(--slate-900)] border-[rgba(124,58,237,0.14)]';
